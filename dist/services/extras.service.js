...
module.exports = {
    ...
    constructPdf: function (content, resv_name_id, hotel, name, lastName, email) {
        return new Promise(function (resolve, reject) {
            var options = {
                "html": content,
                "css": "/home/ubuntu/checkin proyect/new api/dist/stylePdf.css",
            ...
            pdf.convert(options, function (err, result) {
                ...
                result.toFile('/home/ubuntu/checkin proyect/new api/dist/pdf/Pdf-' + resv_name_id + '.pdf', function (data) {
                    console.log("toFile:", data);
                    resolve({ success: "success" });
                    module.exports.sendFilePdf(fileS.createReadStream('/home/ubuntu/checkin proyect/new api/dist/pdf/Pdf-' + resv_name_id + '.pdf')); // to centos path  
